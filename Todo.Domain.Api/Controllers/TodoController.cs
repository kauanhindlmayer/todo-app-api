...
namespace Todo.Domain.Api.Controllers
{
    ...
    public class TodoController : ControllerBase
    {
        ...
        {
            return repository.GetAllUndone("andrebaltieri");
        }
        ...
        {
            return repository.GetByPeriod("andrebaltieri", DateTime.Now.Date.AddDays(1), true);
        ...
        {
            return repository.GetByPeriod("andrebaltieri", DateTime.Now.Date.AddDays(1), false);
